...
import org.rmj.payment.base.FinancerTrans;
import org.rmj.payment.pojo.UnitFinancerTrans;

public class XMFinancerTrans{
    public XMFinancerTrans(GRider foGRider, String fsBranchCd, boolean fbWithParent){
      this.poGRider = foGRider;
      if(foGRider != null){
         this.pbWithParnt = fbWithParent;
         this.psBranchCd = fsBranchCd;
         poControl = new FinancerTrans();
         poControl.setGRider(foGRider);
         poControl.setBranch(psBranchCd);
         poControl.setWithParent(true);
         pnEditMode = EditMode.UNKNOWN;

         poData = new UnitFinancerTrans();
      }
    }
   ...
   public boolean deleteTransaction(String fsTransNox) {
    ...
    private FinancerTrans poControl;
    ...
    private final String pxeModuleName = "org.rmj.payment.base.FinancerTrans";
}