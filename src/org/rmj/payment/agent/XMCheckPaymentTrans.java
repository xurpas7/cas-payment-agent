...
import org.rmj.payment.base.CheckPaymentTrans;
import org.rmj.payment.pojo.UnitCheckPaymentTrans;

public class XMCheckPaymentTrans{
    public XMCheckPaymentTrans(GRider foGRider, String fsBranchCd, boolean fbWithParent){
      this.poGRider = foGRider;
      if(foGRider != null){
         this.pbWithParnt = fbWithParent;
         this.psBranchCd = fsBranchCd;
         poCtrl = new CheckPaymentTrans();
         poCtrl.setGRider(foGRider);
         poCtrl.setBranch(psBranchCd);
         poCtrl.setWithParent(true);
         pnEditMode = EditMode.UNKNOWN;

         poData = new UnitCheckPaymentTrans();
      }
    }
    ...
    public boolean saveUpdate() {
        if(pnEditMode == EditMode.UNKNOWN){
            ...
            UnitCheckPaymentTrans loResult;
   ...
   public boolean deleteTransaction(String fsTransNox) {
    ...
    private CheckPaymentTrans poCtrl;
    private GRider poGRider;
    private int pnEditMode;
    private String psBranchCd;
    private boolean pbWithParnt = false;
    
    private final String pxeModuleName = "org.rmj.payment.base.CheckPaymentTrans";
}
